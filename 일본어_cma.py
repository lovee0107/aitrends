...
import os   
os.environ["CUDA_VISIBLE_DEVICES"] = "4" # 일본어
import torch
...
if output_path is None:
    ...
    output_path = f"results/일본어/{output_path}"
...
acc_ja = outputs.metrics["acc_ja"]

entry = {"t": t, "acc": acc, "acc_ja": acc_ja}
print(acc_ja, flush=True)
